...
<link rel="stylesheet" href="css/ric_tirocinio.css" type="text/css"
	media="all">
...
<body>
	...
	<form action="ProgettoFormativoServlet" method="post"
		name="form_dowload">
		<div>
			<input type="submit" name="Dowload"
				value="Scarica Progetto formativo">
		</div>
	</form>
	...
	<form action="RicercaTirocinioServlet" method="post" name="form_Params">
		<div class="div_Params">
			...
			</select> <input type="text" name="paramText"> <input type="submit"
				name="ricerca" value="ricerca">
		</div>
	</form>

	<section class="container_ricerca"> <!-- <form action="VisualizzaListaTirocini" method="post"> -->
	<%
			...
			<div style="display: inline-block;">
				<form action="Upload.jsp" name="ADD_Tirocinio" class="carica">
					<input type="hidden" name="codiceTirocinio"
						value="<%=codiceTirocinio%>"> <input class="but_caricaRichiesta" type="submit"
						class="carica" value="Carica Richiesta">
				</form>
			</div>
